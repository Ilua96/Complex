...
TEST(equality_ComplexPolar, equality_ComplexPolar_true){
	ComplexLib::ComplexPolar test1(3.0, 4.0);
	ComplexLib::ComplexPolar test2(3.0, 4.0);
...
TEST(equality_ComplexPolar, equality_ComplexPolar_false) {
	ComplexLib::ComplexPolar test1(3.0, 4.0);
	ComplexLib::ComplexPolar test2(3.0, 3.0);
	complex <double> c1(abs(complex <double>(3.0, 4.0)), arg(complex <double>(3.0, 4.0)));
	complex <double> c2(abs(complex <double>(3.0, 3.0)), arg(complex <double>(3.0, 3.0)));
	bool test3;
	if (test1 == test2 && c1 == c2)
		test3 = true;
	else
...
TEST(equality_ComplexPolar, equality_double_true){
	ComplexLib::ComplexPolar test1(3.0, 0.0);
...
TEST(equality_ComplexPolar, equality_double_false) {
	ComplexLib::ComplexPolar test1(3.0, 0.0);
	complex <double> c1(abs(complex <double>(3.0, 0.0)), arg(complex <double>(3.0, 0.0)));
	bool test3;
	if (test1 == 2.0 && c1 == 2.0)
